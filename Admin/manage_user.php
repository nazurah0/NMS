        ...
        <form action="handler/user_handler.php" method="POST">
            <div class="modal-content">
                ...
                <div class="modal-body m-2 row g-2">
                    ...
                    <input name="id" type="hidden" class="form-control " value="<?php echo isset($user['user_id']) ? $user['user_id'] : '' ?>" >


                    <div class="col-md-12">
                        <label for="parent_workAddress" class="form-label mt-3"> Username</label>
                        <input name="username" id="username" type="text" class="form-control " value="<?php echo isset($user['user_id']) ? $user['username'] : '' ?>" >
                    </div>
