...
$pdf->Cell(35	,7,'RECEIPT #',0,0);
$pdf->Cell(34	,5, $payment_type =='ONLINE BANKING'?$transaction_id : $payment_id ,0,1);//end of line
...
$pdf->Cell(34	,5,$payment_date,0,1);//end of line
...
$pdf->Cell(34	,6,number_format($payment_amount,2),1,1,'R');//end of line
...
$pdf->Cell(24	,6,number_format($payment_amount,2),1,1,'R');//end of line



$pdf->Output('', "Payment Receipt - $child_nickname ($payment_date).pdf");
