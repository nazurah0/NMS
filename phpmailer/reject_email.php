...
try {
   ...
   // $mail->addAttachment('/tmp/image.jpg', 'new.jpg');    //Optional name
    ...
    $mail->Subject = "Rejection on Children Registration";
    $mail->Body    = 
    "<div class='card w-100' >
        ...
        <p>Unfortunately we decided to reject your child registration because of reasons below: </p>
        ...
        <p>You may complete the registration requirement by resubmit the registration.</p>
        <p>You can go to our <a href='https://fyp-nurserymanagementsystem.com/'>Nursery Management System</a> to resubmit the registration</p>
    ...
    $mail->send();
    header("location:../Admin/new_register.php?info=The Registration has been rejected");
